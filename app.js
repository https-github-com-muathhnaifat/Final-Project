...
// array to store movies data ,name ,age ,rate,type and src of images 
var movies = [];
...
// search and match the user input and store the data in array 
var result = [];
